---
summary: "Project model overview (purpose/mission/vision/product posture)."
read_when:
...
- Product posture when the durable vision needs a high-level maturity snapshot
- Constraints + resources
- System4D (Container/Compass/Engine/Fog)

Live sequencing and task execution are intentionally not modeled here; use repo-local AK tasks for that truth.
