...
function mutationResultForSite(site: MutationSite, input: { status: MutationResult['status']; durationMs: number; details?: string; mutatedSource?: string; testCommand: string[] }): MutationResult {
