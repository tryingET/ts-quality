...
export declare function renderExplainText(run: Pick<RunArtifact, 'runId' | 'changedFiles' | 'behaviorClaims' | 'governance' | 'verdict' | 'executionWitnesses' | 'mutations' | 'analysisWarnings' | 'nextEvidenceAction'>): string;
